...
-- Ancient Artillery
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(706, (SELECT id FROM monster_deck where class = 'Ancient Artillery'), 0, 17, '[{"block":[{"type":"action","line":["%push%",2]},{"type":"description","line":"Target all adjacent enemies"}]},{"block":[{"type":"action","line":["%shield%",2]}]},{"block":[{"type":"action","line":["%attack%",-2]}]}]');
...
-- Ancient Artillery
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(707, (SELECT id FROM monster_deck where class = 'Ancient Artillery'), 0, 46, '[{"block":[{"type":"action","line":["%attack%",-1]},{"type":"setElement","line":["%immobilize%"]},{"type":"effect","line":"%aoe-triangle-2-side%"}]}]');
...
-- Flame Demon
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(630, (SELECT id FROM monster_deck where class = 'Flame Demon'), 1, 46, '[{"block":[{"type":"action","line":["%attack%",0]}]},{"block":[{"type":"useElement","line":["%fire%","%use%"]}]},{"block":[{"type":"setElement","line":["%aoe-circle%"]}]}]');
...
-- Flame Demon
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(634, (SELECT id FROM monster_deck where class = 'Flame Demon'), 1, 30, '[{"block":[{"type":"useElement","line":["%fire%","%use%"]},{"type":"description","line":"All adjacent enemies"},{"type":"description","line":"suffer 2 damage."}]},{"block":[{"type":"action","line":["%move%",0]}]},{"block":[{"type":"action","line":["%attack%",-2]},{"type":"setElement","line":["%wound%"]},{"type":"action","line":["%target%",2]}]}]');
...
-- Imp
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(680, (SELECT id FROM monster_deck where class = 'Imp'), 1, 43, '[{"block":[{"type":"action","line":["%move%",0]}]},{"block":[{"type":"action","line":["%attack%",-1]},{"type":"action","line":["%target%",2]},{"type":"setElement","line":["%poison%"]}]}]');
...
-- Imp
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(682, (SELECT id FROM monster_deck where class = 'Imp'), 1, 43, '[{"block":[{"type":"action","line":["%move%",0]}]},{"block":[{"type":"action","line":["%attack%",-1]},{"type":"action","line":["%target%",2]},{"type":"setElement","line":["%curse%"]}]}]');
...
-- Living Spirit
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(580, (SELECT id FROM monster_deck where class = 'Living Spirit'), 1, 22, '[{"block":[{"type":"action","line":["%move%",-1]}]},{"block":[{"type":"action","line":["%attack%",-1]},{"type":"setElement","line":["%muddle%"]}]}]');
...
-- Living Spirit
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(581, (SELECT id FROM monster_deck where class = 'Living Spirit'), 1, 33, '[{"block":[{"type":"action","line":["%move%",0]}]},{"block":[{"type":"action","line":["%attack%",-1]},{"type":"description","line":"Target all enemies within range"}]}]');
...
-- Living Spirit
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(586, (SELECT id FROM monster_deck where class = 'Living Spirit'), 0, 55, '[{"block":[{"type":"action","line":["%move%",0]}]},{"block":[{"type":"setElement","line":["%curse%"]},{"type":"description","line":"Target all enemies within range"}]},{"block":[{"type":"setElement","line":["%ice%"]}]}]');
...
-- Living Spirit
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(587, (SELECT id FROM monster_deck where class = 'Living Spirit'), 0, 67, '[{"block":[{"type":"action","line":["%move%",-1]}]},{"block":[{"type":"action","line":["%attack%",1]}]},{"block":[{"type":"useElement","line":["%ice%","%use%"]},{"type":"setElement","line":["%stun%"]}]}]');
...
-- Night Demon
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(667, (SELECT id FROM monster_deck where class = 'Night Demon'), 0, 15, '[{"block":[{"type":"action","line":["%move%",0]}]},{"block":[{"type":"action","line":["%attack%",-1]}]},{"block":[{"type":"special","line":"All adjacent enemies and allies suffer 1 damage."}]},{"block":[{"type":"useElement","line":["%any%","%use%"]}]},{"block":[{"type":"setElement","line":["%dark%"]}]}]');
...
-- Ooze
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(694, (SELECT id FROM monster_deck where class = 'Ooze'), 0, 59, '[{"block":[{"type":"action","line":["%attack%",0]},{"type":"action","line":["%target%",2]},{"type":"setElement","line":["%poison%"]}]}]');
...
-- Savvas Icestorm
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(712, (SELECT id FROM monster_deck where class = 'Savvas Icestorm'), 0, 14, '[{"block":[{"type":"action","line":["%attack%",0]}]},{"block":[{"type":"useElement","line":["%ice%","%use%"]},{"type":"action","line":["%attack%",2]},{"type":"setElement","line":["%immobilize%"]}]},{"block":[{"type":"action","line":["%retaliate%",2]}]},{"block":[{"type":"setElement","line":["%air%"]}]}]');
...
-- Savvas Icestorm
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(714, (SELECT id FROM monster_deck where class = 'Savvas Icestorm'), 1, 47, '[{"block":[{"type":"setElement","line":["%disarm%"]},{"type":"description","line":"Target all adjacent enemies"}]},{"block":[{"type":"action","line":["%move%",0]}]},{"block":[{"type":"action","line":["%attack%",-1]}]},{"block":[{"type":"setElement","line":["%air%"]}]}]');
...
-- Shaman
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(588, (SELECT id FROM monster_deck where class = 'Shaman'), 0, 8, '[{"block":[{"type":"action","line":["%move%",0]}]},{"block":[{"type":"action","line":["%attack%",-1]},{"type":"setElement","line":["%disarm%"]}]}]');
...
-- Shaman
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(589, (SELECT id FROM monster_deck where class = 'Shaman'), 0, 8, '[{"block":[{"type":"action","line":["%move%",-1]}]},{"block":[{"type":"action","line":["%attack%",0]},{"type":"setElement","line":["%immobilize%"]}]}]');
...
-- Shaman
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(595, (SELECT id FROM monster_deck where class = 'Shaman'), 0, 9, '[{"block":[{"type":"action","line":["%move%",1]}]},{"block":[{"type":"action","line":["%attack%",-1]},{"type":"setElement","line":["%curse%"]},{"type":"action","line":["%target%",2]}]}]');
...
-- Spitting Drake
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(559, (SELECT id FROM monster_deck where class = 'Spitting Drake'), 0, 27, '[{"block":[{"type":"action","line":["%attack%",0]},{"type":"action","line":["%target%",2]},{"type":"setElement","line":["%poison%"]}]}]');
...
-- Spitting Drake
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(561, (SELECT id FROM monster_deck where class = 'Spitting Drake'), 0, 89, '[{"block":[{"type":"action","line":["%attack%",-2]},{"type":"setElement","line":["%stun%"]}]}]');
...
-- Wind Demon
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(644, (SELECT id FROM monster_deck where class = 'Wind Demon'), 0, 9, '[{"block":[{"type":"action","line":["%attack%",-1]}]},{"block":[{"type":"action","line":["%heal%",1]},{"type":"description","line":"Self"}]},{"block":[{"type":"useElement","line":["%air%","%use%"]},{"type":"setElement","line":["%invisible%"]},{"type":"description","line":"Self"}]}]');
...
-- Wind Demon
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(650, (SELECT id FROM monster_deck where class = 'Wind Demon'), 0, 43, '[{"block":[{"type":"action","line":["%push%",1]},{"type":"description","line":"Target all adjacent enemies"}]},{"block":[{"type":"action","line":["%attack%",0]}]},{"block":[{"type":"useElement","line":["%earth%","%use%"]},{"type":"action","line":["%range%",-2]}]}]');
...
-- Wind Demon
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(651, (SELECT id FROM monster_deck where class = 'Wind Demon'), 0, 2, '[{"block":[{"type":"action","line":["%shield%",1]}]},{"block":[{"type":"action","line":["%move%",-1]}]},{"block":[{"type":"action","line":["%attack%",-1]}]},{"block":[{"type":"useElement","line":["%any%","%use%"]}]},{"block":[{"type":"setElement","line":["%air%"]}]}]');
