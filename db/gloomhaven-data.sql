...
-- Deep Terror
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(739, (SELECT id FROM monster_deck where class = 'Deep Terror'), 0, 54, '[{"block":[{"type":"action","line":["%wound%",null]}]},{"block":[{"type":"setEffect","line":["%poison%"]},{"type":"effect","line":"Target all adjacent enemies"}]},{"block":[{"type":"action","line":["%attack%",0]},{"type":"action","line":["%range%",4]}]}]');
...
-- Earth Demon
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(636, (SELECT id FROM monster_deck where class = 'Earth Demon'), 1, 40, '[{"block":[{"type":"action","line":["%heal%",3]},{"type":"description","line":"Self"}]},{"block":[{"type":"useElement","line":["%earth%","%use%"]}]},{"block":[{"type":"action","line":["%immobilize%",null]}]},{"block":[{"type":"effect","line":["!*Target all enemies within","%range%",3]}]}]');
...
-- Earth Demon
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(643, (SELECT id FROM monster_deck where class = 'Earth Demon'), 0, 87, '[{"block":[{"type":"action","line":["%move%",0]}]},{"block":[{"type":"action","line":["%attack%",-1]}]},{"block":[{"type":"setEffect","line":["%aoe-4-with-black%"]}]},{"block":[{"type":"useElement","line":["%any%","%use%"]}]},{"block":[{"type":"setElement","line":["%earth%"]}]}]');
...
-- Flame Demon
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(630, (SELECT id FROM monster_deck where class = 'Flame Demon'), 1, 46, '[{"block":[{"type":"action","line":["%attack%",0]}]},{"block":[{"type":"useElement","line":["%fire%","%use%"]}]},{"block":[{"type":"setEffect","line":["%aoe-circle%"]}]}]');
...
-- Flame Demon
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(631, (SELECT id FROM monster_deck where class = 'Flame Demon'), 0, 49, '[{"block":[{"type":"action","line":["%attack%",0]}]},{"block":[{"type":"setEffect","line":["%aoe-line-3-with-black%"]}]},{"block":[{"type":"useElement","line":["%fire%","%use%"]},{"type":"action","line":["%attack%",1]},{"type":"setEffect","line":["%wound%"]}]}]');
...
-- Harrower Infester
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(729, (SELECT id FROM monster_deck where class = 'Harrower Infester'), 0, 30, '[{"block":[{"type":"action","line":["%move%",-1]}]},{"block":[{"type":"action","line":["%attack%",0]},{"type":"aoe","line":"%aoe-line-4-with-black%"}]},{"block":[{"type":"useElement","line":["%dark%","%use%"]},{"type":"action","line":["%heal%",null]},{"type":"description","line":"for each target damaged"}]}]');
...
-- Living Corpse
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(564, (SELECT id FROM monster_deck where class = 'Living Corpse'), 0, 21, '[{"block":[{"type":"action","line":["%move%",1]}]},{"block":[{"type":"action","line":["%muddle%",null]}]},{"block":[{"type":"setEffect","line":["%immobilize%"]},{"type":"effect","line":"Target one adjacent enemy"}]}]');
...
-- Ooze
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(699, (SELECT id FROM monster_deck where class = 'Ooze'), 0, 85, '[{"block":[{"type":"action","line":["%push%",null]}]},{"block":[{"type":"setEffect","line":["%poison%"]},{"type":"effect","line":"Target all adjacent enemies"}]},{"block":[{"type":"action","line":["%attack%",1]},{"type":"action","line":["%range%",-1]}]}]');
...
-- Savvas Icestorm
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(708, (SELECT id FROM monster_deck where class = 'Savvas Icestorm'), 0, 70, '[{"block":[{"type":"action","line":["%push%",2]},{"type":"effect","line":"Target all adjacent enemies"}]},{"block":[{"type":"useElement","line":["%air%","%use%"]},{"type":"action","line":["%push%",null]}]},{"block":[{"type":"action","line":["%attack%",1]},{"type":"action","line":["%range%",1]}]}]');
...
-- Savvas Lavaflow
INSERT INTO monster_ability(card_number, monster_deck_id, shuffle, initiative, attacks) VALUES(720, (SELECT id FROM monster_deck where class = 'Savvas Lavaflow'), 0, 41, '[{"block":[{"type":"action","line":["%move%",0]}]},{"block":[{"type":"action","line":["%attack%",-1]},{"type":"aoe","line":"%aoe-line-4-with-black%"}]},{"block":[{"type":"useElement","line":["%earth%","%use%"]},{"type":"action","line":["%attack%",2,"%immobilize%"]}]}]');
