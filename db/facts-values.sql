...
-- item_card
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('boots of striding', 'items/1-14/boots-of-striding.png', 2, 20, 'legs', 'During your movement, add +2 %move% to a single movement.', 'consumed', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('winged shoes', 'items/1-14/winged-shoes.png', 2, 20, 'legs', 'During your movement, add %jump% to the movement.', 'consumed', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('hide armor', 'items/1-14/hide-armor.png', 2, 10, 'body', 'On the next two sources of damage from attacks targeting you, gain %shield% + 1', 'consumed', 'null', '-1,-1');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('leather armor', 'items/1-14/leather-armor.png', 2, 20, 'body', 'When attacked, the attacker gains Disadvantage on the attack.', 'consumed', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('cloak of invisibility', 'items/1-14/cloak-of-invisibility.png', 2, 20, 'body', 'During your turn, gain %invisible%', 'spent', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('eagle-eye goggles', 'items/1-14/eagle-eye-goggles.png', 2, 30, 'head', 'During your attack, gain Advantage on the entire Attack action.', 'consumed', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('iron helmet', 'items/1-14/iron-helmet.png', 2, 10, 'head', 'When attacked, consider any %2x% attack modifier card the enemy draws to be a %+0% instead.', 'none', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('heater shield', 'items/1-14/heater-shield.png', 2, 20, 'one-hand', 'When damaged by an attack, gain %shield% + 1 for the attack.', 'consumed', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('piercing bow', 'items/1-14/piercing-bow.png', 2, 30, 'two-hands', 'During your ranged attack, ignore all Shield values for the entire Attack action.', 'spent', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('war hammer', 'items/1-14/war-hammer.png', 2, 30, 'two-hands', 'During your melee attack, add %stun% to the entire Attack action.', 'spent', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('poison dagger', 'items/1-14/poison-dagger.png', 2, 20, 'one-hand', 'During your melee attack, add %poison% to a single attack.', 'consumed', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('minor healing potion', 'items/1-14/minor-healing-potion.png', 4, 10, 'small-item', 'During your turn, perform a %heal% 3, Self action.', 'spent', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('minor stamina potion', 'items/1-14/minor-stamina-potion.png', 4, 10, 'small-item', 'During your turn, Recover up to two of your discarded cards.', 'spent', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('minor power potion', 'items/1-14/minor-power-potion.png', 4, 10, 'small-item', 'During your attack, add %attack% +1 to your entire Attack action.', 'spent', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('boots of speed', 'items/15-21/boots-of-speed.png', 2, 30, 'legs', 'At the beginning of a round, after all ability cards have been revealed, increase or decrease your leading initiative value by 10.', 'spent', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('cloak of pockets', 'items/15-21/cloak-of-pockets.png', 2, 20, 'body', 'You can carry two additional items.', 'none', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('empowering talisman', 'items/15-21/empowering-talisman.png', 2, 45, 'head', 'During your turn, Refresh one of your consumed items.', 'consumed', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('battle-axe', 'items/15-21/battle-axe.png', 2, 20, 'two-hands', 'During your single-target melee attack action, turn the attack into the following: %aoe-triangle-2-side%', 'consumed', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('weighted net', 'items/15-21/weighted-net.png', 2, 20, 'two-hands', 'During your ranged attack, add %immobilize% to a single attack.', 'spent', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('minor mana potion', 'items/15-21/minor-mana-potion.png', 4, 10, 'small-item', 'During your turn, create any element. %any%%use%', 'consumed', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('stun powder', 'items/15-21/stun-powder.png', 2, 20, 'small-item', 'During your attack, add %stun% to a single attack.', 'consumed', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('heavy greaves', 'items/22-28/heavy-greaves.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('chainmail', 'items/22-28/chainmail.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('amulet of life', 'items/22-28/amulet-of-life.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('jagged sword', 'items/22-28/jagged-sword.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('long spear', 'items/22-28/long-spear.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('major healing potion', 'items/22-28/major-healing-potion.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('moon earring', 'items/22-28/moon-earring.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('comfortable shoes', 'items/29-35/comfortable-shoes.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('studded leather', 'items/29-35/studded-leather.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('hawk helm', 'items/29-35/hawk-helm.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('tower shield', 'items/29-35/tower-shield.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('volatile bomb', 'items/29-35/volatile-bomb.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('major stamina potion', 'items/29-35/major-stamina-potion.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('falcon figurine', 'items/29-35/falcon-figurine.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('boots of dashing', 'items/36-42/boots-of-dashing.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('robes of evocation', 'items/36-42/robes-of-evocation.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('heavy basinet', 'items/36-42/heavy-basinet.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('hooked chain', 'items/36-42/hooked-chain.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('versatile dagger', 'items/36-42/versatile-dagger.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('major power potion', 'items/36-42/major-power-potion.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('ring of haste', 'items/36-42/ring-of-haste.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('boots of quickness', 'items/43-49/boots-of-quickness.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('splintmail', 'items/43-49/splintmail.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('pendant of dark pacts', 'items/43-49/pendant-of-dark-pacts.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('spiked shield', 'items/43-49/spiked-shield.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('reaping scythe', 'items/43-49/reaping-scythe.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('major mana potion', 'items/43-49/major-mana-potion.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('sun earring', 'items/43-49/sun-earring.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('steel sabatons', 'items/50-56/steel-sabatons.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('shadow armor', 'items/50-56/shadow-armor.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('protective charm', 'items/50-56/protective-charm.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('black knife', 'items/50-56/black-knife.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('staff of eminence', 'items/50-56/staff-of-eminence.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('super healing potion', 'items/50-56/super-healing-potion.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('ring of brutality', 'items/50-56/ring-of-brutality.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('serene sandals', 'items/57-63/serene-sandals.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('cloak of phasing', 'items/57-63/cloak-of-phasing.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('telescopic lens', 'items/57-63/telescopic-lens.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('unstable explosives', 'items/57-63/unstable-explosives.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('wall shield', 'items/57-63/wall-shield.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('doom powder', 'items/57-63/doom-powder.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('lucky eye', 'items/57-63/lucky-eye.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('boots of sprinting', 'items/64-151/boots-of-sprinting.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('platemail', 'items/64-151/platemail.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('mask of terror', 'items/64-151/mask-of-terror.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('balanced blade', 'items/64-151/balanced-blade.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('halberd', 'items/64-151/halberd.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('star earring', 'items/64-151/star-earring.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('second chance ring', 'items/64-151/second-chance-ring.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('boots of levitation', 'items/64-151/boots-of-levitation.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('shoes of happiness', 'items/64-151/shoes-of-happiness.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('blinking cape', 'items/64-151/blinking-cape.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('swordedge armor', 'items/64-151/swordedge-armor.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('circlet of elements', 'items/64-151/circlet-of-elements.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('chain hood', 'items/64-151/chain-hood.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('frigid blade', 'items/64-151/frigid-blade.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('storm blade', 'items/64-151/storm-blade.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('inferno blade', 'items/64-151/inferno-blade.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('tremor blade', 'items/64-151/tremor-blade.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('brilliant blade', 'items/64-151/brilliant-blade.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('night blade', 'items/64-151/night-blade.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('wand of frost', 'items/64-151/wand-of-frost.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('wand of storms', 'items/64-151/wand-of-storms.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('wand of infernos', 'items/64-151/wand-of-infernos.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('wand of tremors', 'items/64-151/wand-of-tremors.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('wand of brilliance', 'items/64-151/wand-of-brilliance.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('wand of darkness', 'items/64-151/wand-of-darkness.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('minor cure potion', 'items/64-151/minor-cure-potion.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('major cure potion', 'items/64-151/major-cure-potion.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('steel ring', 'items/64-151/steel-ring.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('dampening ring', 'items/64-151/dampening-ring.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('scroll of power', 'items/64-151/scroll-of-power.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('scroll of healing', 'items/64-151/scroll-of-healing.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('scroll of stamina', 'items/64-151/scroll-of-stamina.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('rocket boots', 'items/64-151/rocket-boots.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('endurance footwraps', 'items/64-151/endurance-footwraps.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('drakescale boots', 'items/64-151/drakescale-boots.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('magma waders', 'items/64-151/magma-waders.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('robes of summoning', 'items/64-151/robes-of-summoning.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('second skin', 'items/64-151/second-skin.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('sacrificial robes', 'items/64-151/sacrificial-robes.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('drakescale armor', 'items/64-151/drakescale-armor.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('steam armor', 'items/64-151/steam-armor.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('flea-bitten shawl', 'items/64-151/flea-bitten-shawl.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('necklace of teeth', 'items/64-151/necklace-of-teeth.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('horned helm', 'items/64-151/horned-helm.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('drakescale helm', 'items/64-151/drakescale-helm.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('thief''s hood', 'items/64-151/thiefs-hood.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('helm of the mountain', 'items/64-151/helm-of-the-mountain.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('wave crest', 'items/64-151/wave-crest.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('ancient drill', 'items/64-151/ancient-drill.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('skullbane axe', 'items/64-151/skullbane-axe.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('staff of xorn', 'items/64-151/staff-of-xorn.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('mountain hammer', 'items/64-151/mountain-hammer.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('fueled falchion', 'items/64-151/fueled-falchion.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('bloody axe', 'items/64-151/bloody-axe.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('staff of elements', 'items/64-151/staff-of-elements.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('skull of hatred', 'items/64-151/skull-of-hatred.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('staff of summoning', 'items/64-151/staff-of-summoning.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('orb of dawn', 'items/64-151/orb-of-dawn.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('orb of twilight', 'items/64-151/orb-of-twilight.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('ring of skulls', 'items/64-151/ring-of-skulls.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('doomed compass', 'items/64-151/doomed-compass.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('curious gear', 'items/64-151/curious-gear.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('remote spider', 'items/64-151/remote-spider.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('giant remote spider', 'items/64-151/giant-remote-spider.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('black censer', 'items/64-151/black-censer.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('black card', 'items/64-151/black-card.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('helix ring', 'items/64-151/helix-ring.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('heart of the betrayer', 'items/64-151/heart-of-the-betrayer.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('power core', 'items/64-151/power-core.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('resonant crystal', 'items/64-151/resonant-crystal.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('imposing blade', 'items/64-151/imposing-blade.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('focusing ray', 'items/64-151/focusing-ray.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('volatile elixir', 'items/64-151/volatile-elixir.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('silent stiletto', 'items/64-151/silent-stiletto.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('stone charm', 'items/64-151/stone-charm.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('psychic knife', 'items/64-151/psychic-knife.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('sun shield', 'items/64-151/sun-shield.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('utility belt', 'items/64-151/utility-belt.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('phasing idol', 'items/64-151/phasing-idol.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('smoke elixir', 'items/64-151/smoke-elixir.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('pendant of the plague', 'items/64-151/pendant-of-the-plague.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('mask of death', 'items/64-151/mask-of-death.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('master''s lute', 'items/64-151/masters-lute.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('cloak of the hunter', 'items/64-151/cloak-of-the-hunter.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('doctor''s coat', 'items/64-151/doctors-coat.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('elemental boots', 'items/64-151/elemental-boots.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('staff of command', 'items/64-151/staff-of-command.png', 0, 0, '?', '?', '?', 'null', 'null');
INSERT INTO item_card(name, image_path, count, cost, body_part, description, usage, use_slots, modifiers) VALUES ('sword of the sands', 'items/64-151/sword-of-the-sands.png', 0, 0, '?', '?', '?', 'null', 'null');
